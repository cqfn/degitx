...
\begin{description}
  \item[LPD] --- local peer discovery: each peer sends UDP messages containing the locator ID.
    ...
    There are two common ways to implement LDP: \href{http://bittorrent.org/beps/bep_0014.html}{Bep 14} and \href{http://bittorrent.org/beps/bep_0026.html}{Bep 26} ~\cite{bittorrent}, ~\cite{carlsson2012longitudinal}. todo:  Please, check this ref. (Check bittorent and zeroconf researches instead of URL links here)!!!!!
