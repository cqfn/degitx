...
It was designed to implement a voting mechanism, so 2PC, 3PC or Paxos-commit much better than Raft or Paxos here.
...
So this hook couldn't be integrated with Raft or Paxos, but can provide strong consistency via atomic commit algorithm such as 2PC.
...
Objects are uploaded asynchronously and only reference updates are synchronised and locked.
