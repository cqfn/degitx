...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} Gitaly}\moduleRightDash\cl{}
\fl{ {\EXTENDS} TLC ,\, Naturals ,\, FiniteSets ,\, Sequences}
\fl{}
\fl{ {\p@mmalgorithm} GitalyCommit}
\fl{}
\fl{ {\p@variables}}
\fl{}
 \fl{ RM \.{=} {\langle}\@w{r0} ,\,\@w{r1} ,\,\@w{r2} ,\,\@w{r3} ,\,\@w{r4}
 ,\,\@w{r5} {\rangle} {\p@semicolon}}
\fl{}
\fl{ Nodes \.{=} Tail ( RM ) {\p@semicolon}%
\@y{\@s{0}%
 Assumed \ensuremath{r0} is the master node.
}%
}
\fl{}
\fl{}
...
\fl{}
\fl{}
 \fl{ rmState \.{=} {\langle}\@w{prepared} {\rangle} \.{\circ} [ n \.{\in}
 {\DOMAIN} Nodes \.{\mapsto}\@w{working} ] {\p@semicolon}}
\fl{}
\fl{}
\fl{ preparedNodes \.{=} \{ \} {\p@semicolon}}
\fl{ committedNodes \.{=} \{ \} {\p@semicolon}}
\fl{ abortedNodes \.{=} \{ \} {\p@semicolon}}
\fl{}
\fl{ {\p@process} atomicCommit \.{=} 1}
\fl{ {\p@begin}}
\fl{ mainLoop\@s{.5}\textrm{:}\@s{3}}
\fl{}
 \fl{ {\p@while} Cardinality ( committedNodes ) \.{*} 2 \.{<} Len ( RM )
 \.{\land} Cardinality ( abortedNodes ) \.{*} 2 \.{<} Len ( RM ) {\p@do}}
\fl{ prepareNodes\@s{.5}\textrm{:}\@s{3}}
\fl{}
\fl{ {\p@with} node \.{\in} 2 \.{\dotdot} Len ( RM ) {\p@do}}
\fl{ {\p@either}}
 \fl{ rmState [ node ]}\al{38}{4}{ \.{:=}}\al{38}{5}{\@w{prepared}
 {\p@semicolon}}
 \fl{ preparedNodes}\al{39}{1}{ \.{:=}}\al{39}{2}{ preparedNodes \.{\cup} \{
 RM [ node ] \} {\p@semicolon}}
\fl{ {\p@or}}
\fl{ rmState [ node ] \.{:=}\@w{aborted} {\p@semicolon}}
 \fl{ abortedNodes \.{:=} abortedNodes \.{\cup} \{ RM [ node ] \}
 {\p@semicolon}}
\fl{ {\p@end} {\p@either} {\p@semicolon}}
\fl{ {\p@end} {\p@with} {\p@semicolon}}
\fl{ nextStep\@s{.5}\textrm{:}\@s{3}}
\fl{}
 \fl{ {\p@if}}\al{47}{1}{ \E\, n \.{\in} {\DOMAIN} RM \.{:} rmState [ n ]
 \.{=}\@w{working} {\p@then}}
\fl{ {\p@goto} prepareNodes {\p@semicolon}}
\fl{ {\p@else}}
\fl{ {\p@goto} masterDecide {\p@semicolon}}
\fl{ {\p@end} {\p@if} {\p@semicolon}}
\fl{ masterDecide\@s{.5}\textrm{:}\@s{3}}
\fl{}
\fl{ {\p@either}}
 \fl{ {\p@await} Cardinality ( preparedNodes ) \.{*} 2 \.{\geq} Len ( Nodes )
 \.{\land} rmState [ 1 ] \.{=}\@w{prepared} {\p@semicolon}}
\fl{ rmState [ 1 ] \.{:=}\@w{committed} {\p@semicolon}}
\fl{ {\p@or}}
 \fl{ {\p@await} Cardinality ( abortedNodes ) \.{*} 2 \.{>} Len ( Nodes )
 {\p@semicolon}}
\fl{ rmState [ 1 ] \.{:=}\@w{aborted} {\p@semicolon}}
\fl{ {\p@end} {\p@either} {\p@semicolon}}
\fl{ nodesWrite\@s{.5}\textrm{:}\@s{3}}
\fl{}
\fl{ {\p@with} node \.{\in} 2 \.{\dotdot} Len ( RM ) {\p@do}}
 \fl{ {\p@await} rmState [ 1 ] \.{\in} \{\@w{committed} ,\,\@w{aborted} \}
 \.{\land} rmState [ node ] \.{\notin} \{\@w{committed} ,\,\@w{aborted} \}
 {\p@semicolon}}
\fl{ rmState [ node ] \.{:=} rmState [ 1 ] {\p@semicolon}}
\fl{ {\p@end} {\p@with} {\p@semicolon}}
\fl{ {\p@end} {\p@while} {\p@semicolon}}
...
\fl{}
\fl{}
 \fl{ {\VARIABLES} RM ,\, Nodes ,\, rmState ,\, preparedNodes ,\,
 committedNodes ,\, abortedNodes ,\, pc}
\fl{}
 \fl{ vars \.{\defeq} {\langle}}\al{75}{3}{ RM ,\, Nodes ,\, rmState ,\,
 preparedNodes ,\, committedNodes ,\, abortedNodes ,\,}
\fl{ pc {\rangle}}
\fl{}
\fl{ ProcSet \.{\defeq} \{ 1 \}}
\fl{}
\fl{ Init \.{\defeq}}\al{80}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
 \fl{ \.{\land}}\al{81}{1}{ RM \.{=} {\langle}\@w{r0} ,\,\@w{r1} ,\,\@w{r2}
 ,\,\@w{r3} ,\,\@w{r4} ,\,\@w{r5} {\rangle}}
\fl{ \.{\land}}\al{82}{1}{ Nodes \.{=} Tail ( RM )}
 \fl{ \.{\land}}\al{83}{1}{ rmState \.{=} {\langle}\@w{prepared} {\rangle}
 \.{\circ} [ n \.{\in} {\DOMAIN} Nodes \.{\mapsto}\@w{working} ]}
\fl{ \.{\land}}\al{84}{1}{ preparedNodes \.{=} \{ \}}
\fl{ \.{\land}}\al{85}{1}{ committedNodes \.{=} \{ \}}
\fl{ \.{\land}}\al{86}{1}{ abortedNodes \.{=} \{ \}}
 \fl{ \.{\land}}\al{87}{1}{ pc \.{=} [ self \.{\in} ProcSet
 \.{\mapsto}\@w{mainLoop} ]}
\fl{}
 \fl{ mainLoop \.{\defeq}}\al{89}{2}{ \.{\land}}\al{89}{3}{ pc [ 1 ]
 \.{=}\@w{mainLoop}}
 \fl{ \.{\land}}\al{90}{1}{ {\IF}}\al{90}{2}{ Cardinality ( committedNodes )
 \.{*} 2 \.{<} Len ( RM ) \.{\land} Cardinality ( abortedNodes ) \.{*} 2
 \.{<} Len ( RM )}
 \fl{ \.{\THEN}}\al{91}{1}{ \.{\land}}\al{91}{2}{ pc \.{'}}\al{91}{4}{
 \.{=}}\al{91}{5}{ [ pc {\EXCEPT} {\bang} [ 1 ]}\al{91}{12}{
 \.{=}}\al{91}{13}{\@w{prepareNodes} ]}
 \fl{ \.{\ELSE}}\al{92}{1}{ \.{\land}}\al{92}{2}{ pc \.{'}}\al{92}{4}{
 \.{=}}\al{92}{5}{ [ pc {\EXCEPT} {\bang} [ 1 ]}\al{92}{12}{
 \.{=}}\al{92}{13}{\@w{Done} ]}
 \fl{ \.{\land}}\al{93}{1}{ {\UNCHANGED} {\langle}}\al{93}{3}{ RM ,\, Nodes
 ,\, rmState ,\, preparedNodes ,\, committedNodes ,\,}
\fl{ abortedNodes {\rangle}}
\fl{}
 \fl{ prepareNodes \.{\defeq}}\al{96}{2}{ \.{\land}}\al{96}{3}{ pc [ 1 ]
 \.{=}\@w{prepareNodes}}
\fl{ \.{\land}}\al{97}{1}{ \E\, node \.{\in} 2 \.{\dotdot} Len ( RM ) \.{:}}
 \fl{ \.{\lor}}\al{98}{1}{ \.{\land}}\al{98}{2}{ rmState \.{'} \.{=} [ rmState
 {\EXCEPT} {\bang} [ node ] \.{=}\@w{prepared} ]}
 \fl{ \.{\land}}\al{99}{1}{ preparedNodes \.{'} \.{=} ( preparedNodes \.{\cup}
 \{ RM [ node ] \} )}
\fl{ \.{\land}}\al{100}{1}{ {\UNCHANGED} abortedNodes}
 \fl{ \.{\lor}}\al{101}{1}{ \.{\land}}\al{101}{2}{ rmState \.{'} \.{=} [
 rmState {\EXCEPT} {\bang} [ node ] \.{=}\@w{aborted} ]}
 \fl{ \.{\land}}\al{102}{1}{ abortedNodes \.{'} \.{=} ( abortedNodes \.{\cup}
 \{ RM [ node ] \} )}
\fl{ \.{\land}}\al{103}{1}{ {\UNCHANGED} preparedNodes}
 \fl{ \.{\land}}\al{104}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{nextStep} ]}
 \fl{ \.{\land}}\al{105}{1}{ {\UNCHANGED} {\langle} RM ,\, Nodes ,\,
 committedNodes {\rangle}}
\fl{}
 \fl{ nextStep \.{\defeq}}\al{107}{2}{ \.{\land}}\al{107}{3}{ pc [ 1 ]
 \.{=}\@w{nextStep}}
 \fl{ \.{\land}}\al{108}{1}{ {\IF}}\al{108}{2}{ \E\, n \.{\in} {\DOMAIN} RM
 \.{:} rmState [ n ] \.{=}\@w{working}}
 \fl{ \.{\THEN}}\al{109}{1}{ \.{\land}}\al{109}{2}{ pc \.{'}}\al{109}{4}{
 \.{=}}\al{109}{5}{ [ pc {\EXCEPT} {\bang} [ 1 ]}\al{109}{12}{
 \.{=}}\al{109}{13}{\@w{prepareNodes} ]}
 \fl{ \.{\ELSE}}\al{110}{1}{ \.{\land}}\al{110}{2}{ pc \.{'}}\al{110}{4}{
 \.{=}}\al{110}{5}{ [ pc {\EXCEPT} {\bang} [ 1 ]}\al{110}{12}{
 \.{=}}\al{110}{13}{\@w{masterDecide} ]}
 \fl{ \.{\land}}\al{111}{1}{ {\UNCHANGED} {\langle}}\al{111}{3}{ RM ,\, Nodes
 ,\, rmState ,\, preparedNodes ,\, committedNodes ,\,}
\fl{ abortedNodes {\rangle}}
\fl{}
 \fl{ masterDecide \.{\defeq}}\al{114}{2}{ \.{\land}}\al{114}{3}{ pc [ 1 ]
 \.{=}\@w{masterDecide}}
 \fl{ \.{\land}}\al{115}{1}{ \.{\lor}}\al{115}{2}{ \.{\land}}\al{115}{3}{
 Cardinality ( preparedNodes ) \.{*} 2 \.{\geq} Len ( Nodes ) \.{\land}
 rmState [ 1 ] \.{=}\@w{prepared}}
 \fl{ \.{\land}}\al{116}{1}{ rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 1 ] \.{=}\@w{committed} ]}
 \fl{ \.{\lor}}\al{117}{1}{ \.{\land}}\al{117}{2}{ Cardinality ( abortedNodes
 ) \.{*} 2 \.{>} Len ( Nodes )}
 \fl{ \.{\land}}\al{118}{1}{ rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 1 ] \.{=}\@w{aborted} ]}
 \fl{ \.{\land}}\al{119}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{nodesWrite} ]}
 \fl{ \.{\land}}\al{120}{1}{ {\UNCHANGED} {\langle}}\al{120}{3}{ RM ,\, Nodes
 ,\, preparedNodes ,\, committedNodes ,\,}
\fl{ abortedNodes {\rangle}}
\fl{}
 \fl{ nodesWrite \.{\defeq}}\al{123}{2}{ \.{\land}}\al{123}{3}{ pc [ 1 ]
 \.{=}\@w{nodesWrite}}
\fl{ \.{\land}}\al{124}{1}{ \E\, node \.{\in} 2 \.{\dotdot} Len ( RM ) \.{:}}
 \fl{ \.{\land}}\al{125}{1}{ rmState [ 1 ] \.{\in} \{\@w{committed}
 ,\,\@w{aborted} \} \.{\land} rmState [ node ] \.{\notin} \{\@w{committed}
 ,\,\@w{aborted} \}}
 \fl{ \.{\land}}\al{126}{1}{ rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 node ] \.{=} rmState [ 1 ] ]}
 \fl{ \.{\land}}\al{127}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{mainLoop} ]}
 \fl{ \.{\land}}\al{128}{1}{ {\UNCHANGED} {\langle}}\al{128}{3}{ RM ,\, Nodes
 ,\, preparedNodes ,\, committedNodes ,\,}
\fl{ abortedNodes {\rangle}}
\fl{}
 \fl{ atomicCommit \.{\defeq}}\al{131}{2}{ mainLoop \.{\lor} prepareNodes
 \.{\lor} nextStep \.{\lor} masterDecide}
\fl{ \.{\lor} nodesWrite}
\fl{}
\fl{}
 \fl{ Terminating \.{\defeq}}\al{135}{2}{ \.{\land}}\al{135}{3}{ \A\, self
 \.{\in} ProcSet \.{:} pc [ self ] \.{=}\@w{Done}}
\fl{ \.{\land}}\al{136}{1}{ {\UNCHANGED} vars}
\fl{}
\fl{ Next}\al{138}{1}{ \.{\defeq}}\al{138}{2}{ atomicCommit}
\fl{ \.{\lor} Terminating}
\fl{}
 \fl{ Spec}\al{141}{1}{ \.{\defeq}}\al{141}{2}{ Init \.{\land} {\Box} [ Next
 ]_{ vars}}
\fl{}
